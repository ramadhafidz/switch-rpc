...
2026-09-20, sampled with `scripts/idle-cpu.ps1` (TotalProcessorTime over a
...
``` text
PS> powershell -ExecutionPolicy Bypass -File scripts/idle-cpu.ps1 -Name SwitchRpc.Poc -Seconds 60
...
``` text
PS> powershell -ExecutionPolicy Bypass -File scripts/idle-cpu.ps1 -Name python -Id 23444 -Seconds 60
...
``` text
PS> powershell -ExecutionPolicy Bypass -File scripts/idle-cpu.ps1 -Name python -Id 26464 -Seconds 60
